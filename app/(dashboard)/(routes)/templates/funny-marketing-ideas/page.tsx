...
const Page = () => {
  ...
  const { mutate, isLoading } = useMutation({
    ...
    mutationFn: async ({
      ...
      const prompt = `Write a Unique funny marketing idea for the product ${productName}, The description of the product is ${productDescription}. They are targeting ${audience}. Write a very ridiculous marketing Idea keeping the tone of voice ${toneOfVoice}. The Funny marketing idea should be compelling so that the viewer is tempted to convert into sales. Remember to only write the unique Funny marketing Idea for the given input product. Note:- Do not write other than the Unique funny marketing idea`;
      ...
      await axios.post("/api/history", {
        ...
        content: data,
        type: HistoryType.FUNNY_MARKETING_IDEAS,
      });
      return data;
    },
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="w-full">
                  ...
                  <FormControl>
                    <Input placeholder="Funny, Witty" {...field} />
                  </FormControl>
                  <FormDescription className="text-right">
