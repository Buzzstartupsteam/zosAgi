...
const Page = () => {
  ...
  const { mutate, isLoading } = useMutation({
    ...
    mutationFn: async ({
      ...
      const prompt = `write an SEO meta title and meta description of the blog title ${title} for the product named ${productName}. The description of the blog is ${productDescription}. Write an SEO meta title and meta description using the keywords ${keywords},.
      The SEO meta title and meta description should be compelling so that the viewer is tempted to interact. Remember to only write an SEO meta title and meta description for the given input blog. Note:- Do not write other than the SEO meta title and meta description. Important point:- The meta-title has a word limit of 10 words so do not write the meta-title more than 10 words and the meta-description has a word limit of 25 words so do not write the meta-description more than 25 words.
      Response format:-
      Title:- meta title
      ...
      await axios.post("/api/history", {
        ...
        type: HistoryType.SEO_BLOG_POSTS_TITLE_AND_META_DESCRIPTIONS,
      });
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="w-full">
                  ...
                  <FormControl>
                    <Input placeholder="Keywords related to blog" {...field} />
                  </FormControl>
                  <FormDescription className="text-right">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>What is this blog about?</FormLabel>
                <FormControl>
                  <Textarea
                    placeholder="A brief summary or topic of the blog post."
                    {...field}
