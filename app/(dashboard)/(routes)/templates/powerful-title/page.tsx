...
const Page = () => {
  ...
  const { mutate, isLoading } = useMutation({
    ...
    mutationFn: async ({
      ...
      const prompt = `Write the perfect headline for the product${productName}, targeting ${audience}, and the description about the product is  ${productDescription}. Write 4-5 Perfect headlines in bullet points for the given product keeping the tone of voice ${toneOfVoice}. The headlines should be compelling so that the viewer is tempted to interact. Remember to only write the 4-5 Perfect headlines in bullet points for the given input product. Note:- Do not write other than the 4-5 Perfect headlines in bullet points`;
      ...
      await axios.post("/api/history", {
        ...
        type: HistoryType.POWERFUL_TITLE,
      });
