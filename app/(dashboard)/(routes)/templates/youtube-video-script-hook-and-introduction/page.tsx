...
const Page = () => {
  ...
  const { mutate, isLoading } = useMutation({
    ...
    mutationFn: async ({
      ...
      const prompt = `Write a YouTube video Script Hook and Introduction of video title ${videoTitle}. The Video is about ${description}. Write a YouTube video Script Hook and Introduction using the tone of voice ${toneOfVoice}. The YouTube video Script Hook and Introduction should be compelling so that the viewer is tempted to interact. Remember to only write a YouTube video Script Hook and Introduction for the given input video title. Note:- Do not write other than the YouTube video Script Hook and Introduction. 
      Response format:-
      Hook:- hook
      ...
      await axios.post("/api/history", {
        ...
        type: HistoryType.YOUTUBE_VIDEO_SCRIPT_HOOK_AND_INTRODUCTION,
      });
      return dataArray;
    },
