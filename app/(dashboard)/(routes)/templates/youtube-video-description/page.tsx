...
const Page = () => {
  ...
  const { mutate, isLoading } = useMutation({
    ...
    mutationFn: async ({
      ...
      const prompt = `Write a Youtube video description for the video title ${videoTitle}, the video is about ${description} and the title of the video is ${videoTitle}. write the YouTube video description keeping the tone of voice ${toneOfVoice}. the keywords are ${keywords}, The YouTube video description should be compelling so that the viewer is tempted to interact. Remember to only write the YouTube video description for the given YouTube video. Note:- Do not write other than the youtube video description.`;
      ...
      await axios.post("/api/history", {
        ...
        content: data,
        type: HistoryType.YOUTUBE_VIDEO_DESCRIPTION,
      });
      return data;
    },
