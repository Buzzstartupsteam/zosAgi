...
const Page = () => {
  ...
  const { mutate, isLoading } = useMutation({
    ...
    mutationFn: async ({
      ...
      const prompt = `Write a unique selling proposition for the product  ${productName}, the product description is ${productDescription}and the product is targeting ${audience}. write the unique selling proposition keeping the tone of voice ${toneOfVoice}. The unique selling proposition should be compelling so that the viewer is tempted to buy. Remember to only write the unique selling proposition for the given product. Note:- Do not write other than a unique selling proposition. Important point:- The short unique selling proposition has a word limit of 10 words so do not write the unique selling proposition more than 10 words.`;
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="w-full">
                  ...
                  <FormControl>
                    <Input placeholder="Young Adults, Programers" {...field} />
                  </FormControl>
                  <FormDescription className="text-right">
