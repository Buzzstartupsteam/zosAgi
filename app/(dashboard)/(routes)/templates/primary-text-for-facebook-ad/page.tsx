...
const Page = () => {
  ...
  const { mutate, isLoading } = useMutation({
    ...
    mutationFn: async ({
      ...
      const prompt = `write a primary text for a Facebook ad for the product named ${productName} that is targeting ${audience}. The description of the product is ${productDescription}. Write a primary text for a Facebook ad keeping the tone of voice ${toneOfVoice}.
      The primary text for a Facebook ad should be compelling so that the viewer is tempted to convert into sales. Remember to only write primary text for a Facebook ad for the given input product. Note:- Do not write other than the primary text for a Facebook ad. Important point:- The character limit is 125 so do not write more than 20 words or 125 character`;
      ...
      await axios.post("/api/history", {
        ...
        content: data,
        type: HistoryType.PRIMARY_TEXT_FOR_FACEBOOK_AD,
      });
