...
const Page = () => {
  ...
  const { mutate, isLoading } = useMutation({
    mutationFn: async ({
      ...
      const prompt = `write a Facebook ad title for the product named ${productName} that is targeting ${audience}. The description of the product is ${productDescription}. Write a 20-word Facebook AD title keeping the tone of voice ${toneOfVoice}.
      This Facebook ad title should be attractive to read so that the viewer is compelled to click. the word limit is 20. Remember to only write responses to the given product. Note:-  Do not write a title of more than 20 words`;
      ...
      await axios.post("/api/history", {
        ...
        type: HistoryType.FACEBOOK_AD_TITLE,
      });
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="w-full">
                  ...
                  <FormControl>
                    <Input placeholder="Bold, Witty" {...field} />
                  </FormControl>
                  <FormDescription className="text-right">
